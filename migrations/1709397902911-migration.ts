...
export class Migration1709397902911 implements MigrationInterface {
    name = 'Migration1709397902911'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`product_color_sizes\` (\`id\` int NOT NULL AUTO_INCREMENT, \`product_color_id\` int NOT NULL, \`size_id\` int NOT NULL, \`cost_price\` int NOT NULL, \`qty\` int NOT NULL, \`min_qty\` int NOT NULL, UNIQUE INDEX \`REL_0579dc0e91fee1ce420565003a\` (\`size_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
