...
export class Migration1767742457468 implements MigrationInterface {
    name = 'Migration1767742457468'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` DROP COLUMN \`width\``);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` DROP COLUMN \`height\``);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` DROP COLUMN \`length\``);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` DROP COLUMN \`weight\``);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD \`title\` varchar(150) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD \`descriptions\` json NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`product_variant_discounts\` CHANGE \`startDate\` \`startDate\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variant_discounts\` CHANGE \`endDate\` \`endDate\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variant_discounts\` CHANGE \`product_variant_id\` \`product_variant_id\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD CONSTRAINT \`FK_bbb3b5757c05b67ca4377ef2385\` FOREIGN KEY (\`productVariantId\`) REFERENCES \`product_variants\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product_variant_discounts\` CHANGE \`product_variant_id\` \`product_variant_id\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variant_discounts\` CHANGE \`endDate\` \`endDate\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variant_discounts\` CHANGE \`startDate\` \`startDate\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variant_discounts\` ADD CONSTRAINT \`FK_a90e9e74f2f7158aa5bd8efec3a\` FOREIGN KEY (\`product_variant_id\`) REFERENCES \`product_variants\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` DROP COLUMN \`descriptions\``);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` DROP COLUMN \`title\``);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD \`weight\` decimal(10,2) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD \`length\` decimal(10,2) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD \`height\` decimal(10,2) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variant_measurements\` ADD \`width\` decimal(10,2) NULL DEFAULT 'NULL'`);
    }
