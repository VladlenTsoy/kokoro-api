...
export class Create1701512336043 implements MigrationInterface {
    name = "Create1701512336043"
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`product_categories\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`parent_category_id\` int NULL, \`is_hide\` tinyint NULL, \`created_at\` timestamp NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`)
        await queryRunner.query(`CREATE TABLE \`sizes\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`is_hide\` tinyint NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`)
        ...
        await queryRunner.query(`CREATE TABLE \`colors\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`hex\` varchar(255) NOT NULL, \`is_hide\` tinyint NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`)
    }
